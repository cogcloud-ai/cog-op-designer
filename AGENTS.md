...
The composition bridge is copied from cog-workbench's `bridges/context_bridge.py`
(https://github.com/cogcloud-ai/cog-workbench/blob/main/bridges/context_bridge.py).
